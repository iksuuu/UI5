		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SQL Agent",
									"targetURL": "#sapui5walkthroughpythonui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5walkthroughpythonui5-display": {
								"semanticObject": "sapui5walkthroughpythonui5",
								"action": "display",
								"description": "An SAP Fiori application to connect python backend",
								"title": "SQL Agent",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui5.walkthrough.pythonui5",
									"url": sap.ui.require.toUrl("sap/ui5/walkthrough/pythonui5")
								}
							}
						}
					}
